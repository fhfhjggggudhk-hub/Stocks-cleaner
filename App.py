...
st.caption(
    "প্রপার সাপোর্ট ও রেজিস্ট্যান্স লেভেলে তৈরি হওয়া বুলিশ এবং বেয়ারিশ রিভার্সাল প্যাটার্ন।"
)
...
if start_scan:
    st.write(
        f"**{selected_category}** সেকশনের ১০০টি স্টকে প্রপার সাপোর্ট ও"
        " রেজিস্ট্যান্স স্ক্যান করা হচ্ছে..."
    )
    bullish_results = []
    bearish_results = []
    ...
    tab_bullish, tab_bearish = st.tabs([
        f"🟢 Bullish Setups - At Support ({len(bullish_results)})",
        f"🔴 Bearish Setups - At Resistance ({len(bearish_results)})",
    ])

    with tab_bullish:
        if bullish_results:
            st.subheader("🟢 সাপোর্টে তৈরি হওয়া কনফার্মড বুলিশ সেটআপ:")
            render_cards(bullish_results)
        else:
            st.info(
                "⚠️ এই মুহূর্তে এই সাব-সেক্টরের কোনো স্টক প্রপার সাপোর্টে বুলিশ"
                " রিভার্সাল তৈরি করেনি।"
            )

    with tab_bearish:
        if bearish_results:
            st.subheader("🔴 রেজিস্ট্যান্সে তৈরি হওয়া কনফার্মড বেয়ারিশ সেটআপ:")
            render_cards(bearish_results)
        else:
            st.info(
                "⚠️ এই মুহূর্তে এই সাব-সেক্টরের কোনো স্টক প্রপার রেজিস্ট্যান্সে"
                " বেয়ারিশ রিভার্সাল তৈরি করেনি।"
            )
